...
Now we are down to `r dim(train)[2]` columns, and one of those is the variable we will be predicting, so really it is one less than that.  Next, a quick look at the second and third columns that remain.
...
These columns can be removed too.
